...
export const ACCENT_COLOR  = process.env.NEXT_PUBLIC_ACCENT_COLOR  || '#cf2e2e';
...
// Article / advertorial layout vars
export const FOUNDER_PHOTO_URL = process.env.NEXT_PUBLIC_FOUNDER_PHOTO_URL || '';
export const OWNER_BIO         = process.env.NEXT_PUBLIC_OWNER_BIO         || '';
export const TRUST_STATS       = process.env.NEXT_PUBLIC_TRUST_STATS       || '';
export const NEWS_VIDEO_1_URL  = process.env.NEXT_PUBLIC_NEWS_VIDEO_1_URL  || '';
export const NEWS_VIDEO_2_URL  = process.env.NEXT_PUBLIC_NEWS_VIDEO_2_URL  || '';
